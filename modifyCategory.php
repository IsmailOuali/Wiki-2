...
<html lang="en">
   ...
   <section class="pt-40" id="category-page">
         <div class=" rounded-sm">
            <form class="w-2/4 max-w-sm" action="controller/modifyCategory.php?id=<?php echo $_POST['idCategory'] ?>" method="post">
               <div class="flex items-center border-b border-teal-500 py-2">
              <input class="appearance-none bg-transparent border-none text-white w-full mr-3 py-1 px-2" type="text" placeholder="Modify category name" aria-label="Full name" name="category-name">
              <input class="flex-shrink-0 bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white py-1 px-2 rounded" type="submit" name="submit-categorie" value="Modifier Category">
            </form>
        </div>
    </section>
